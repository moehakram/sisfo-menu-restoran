...
class ReservasiModel extends \App\Core\MVC\Model {
    ...
    public function getMenuById($id) {
        $query = "SELECT 213049_id AS id, 213049_menu_nama AS nama, 213049_menu_harga AS harga, 213049_menu_stok AS stok FROM tbl_menu_213049 WHERE 213049_id = :id";
        $statement = $this->connection->prepare($query);
...
WHERE o.`213049_id` = :idOrder  AND o.`213049_idstatus` = 2";
    ...
    public function meja(){
        ...
        $sql = "SELECT 213049_no_meja, 213049_status_meja FROM tbl_meja_213049 WHERE `213049_status_meja` = 1";
    ...
    public function getMeja(){
        ...
        $sql = "SELECT 213049_no_meja AS meja FROM tbl_meja_213049 WHERE `213049_status_meja` = 1";
        // Persiapkan statement
        $statement = $this->connection->prepare($sql);
        // Eksekusi statement
        $statement->execute();
